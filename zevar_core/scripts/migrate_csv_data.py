    ...
    if os.path.exists(supplier_file):
        ...
        with open(supplier_file, encoding='utf-8', errors='ignore') as f:
            ...
            for row in reader:
                ...
                if frappe.db.exists('Supplier', {'supplier_name': supplier_name}): continue
    ...
    if os.path.exists(item_file):
        ...
        with open(item_file, encoding='utf-8', errors='ignore') as f:
            ...
            for row in reader:
                ...
                if not sku: continue
                if frappe.db.exists('Item', {'item_code': sku}): continue
    ...
    if os.path.exists(customer_file):
        ...
        with open(customer_file, encoding='utf-8', errors='ignore') as f:
            ...
            for row in reader:
                ...
                if frappe.db.exists('Customer', {'customer_name': customer_name}): continue

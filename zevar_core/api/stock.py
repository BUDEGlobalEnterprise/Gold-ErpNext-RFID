...
def get_supplier_orders(status=None, supplier=None, from_date=None, to_date=None, page=1, page_size=20):
    ...
    orders = frappe.get_all(
        ...
        fields=[
            ...
            "schedule_date", "status", "grand_total", "currency",
...
def create_purchase_order(supplier, items_json, warehouse=None, schedule_date=None):
    ...
    for item in items:
        ...
        po.append("items", {
            ...
            "warehouse": item.get("warehouse") or warehouse or frappe.defaults.get_user_default("Warehouse"),
...
def get_assemblies(status=None, purpose=None, page=1, page_size=20):
    ...
    entries = frappe.get_all(
        ...
        filters=filters,
        fields=[
            "name", "purpose", "posting_date", "from_warehouse",
            "to_warehouse", "total_amount", "docstatus",
        ],
        order_by="posting_date desc",
        limit_start=limit_start,
        limit=page_size,
...
def get_metals(page=1, page_size=50):
    ...
    items = frappe.get_all(
        ...
        fields=[
            ...
            "stock_uom", "standard_rate", "valuation_rate",
            "custom_metal_type", "custom_purity", "custom_gross_weight",
        ],
        limit_start=limit_start,
        limit=page_size,
    )
...
def get_gems(gem_type=None, certified_only=0, page=1, page_size=50):
    ...
    items = frappe.get_all(
        ...
        fields=[
            ...
            "custom_gem_type", "custom_carat_weight", "custom_gem_shape",
            "custom_gem_color", "custom_gem_clarity", "custom_gem_cut",
...
def get_warehouses(parent=None, page=1, page_size=50):
    ...
    warehouses = frappe.get_all(
        ...
        fields=[
            ...
            "is_group", "warehouse_type", "company",
        ],
        order_by="lft asc",
        limit_start=limit_start,
        limit=page_size,

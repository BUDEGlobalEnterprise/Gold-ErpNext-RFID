			...
			<div class="flex flex-col md:flex-row md:items-end justify-between gap-8">
				<div>
					...
					<p class="text-gray-500 font-medium font-sans">
						Connect with the brilliant minds behind our jewelry atelier.
					</p>
				</div>
				<div class="flex items-center gap-4">
					<div class="relative w-80 group">
						<span
							class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg group-focus-within:text-primary transition-colors"
							>search</span
						>
						<input
							type="search"
							placeholder="Find resonance..."
							class="w-full bg-white border border-gray-100 rounded-xl py-3 pl-12 pr-6 text-sm focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all shadow-sm placeholder-gray-400"
						/>
					</div>
					<button
		...
		<div class="space-y-10">
			...
			<div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
				...
				>
					...
					<p
						class="text-[40px] font-black text-emerald-600 tracking-tighter tabular-nums leading-none"
					>
						94
					</p>
				</div>
				...
				>
					...
					<p
						class="text-[40px] font-black text-blue-600 tracking-tighter tabular-nums leading-none"
					>
						12
					</p>
				</div>
				...
				>
					...
					<p
						class="text-[40px] font-black text-amber-600 tracking-tighter tabular-nums leading-none"
					>
						08
					</p>
				</div>
				...
				>
					...
					<p
						class="text-[40px] font-black text-gray-300 tracking-tighter tabular-nums leading-none"
					>
						14
					</p>
				</div>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
				...
				>
					<div class="absolute top-4 right-4">
						<div
							class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-50 border border-emerald-100"
							v-if="member.status === 'Available'"
						>
							<span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
							<span
								class="text-[8px] font-black uppercase tracking-widest text-emerald-700"
								>Live</span
							>
						</div>
						<div
							class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-amber-50 border border-amber-100"
							v-else
						>
							<span class="w-1.5 h-1.5 rounded-full bg-amber-500"></span>
							<span
								class="text-[8px] font-black uppercase tracking-widest text-amber-700"
								>Busy</span
							>
						</div>
					</div>
					...
					<div class="p-8 pb-6">
						...
						<h3
							class="text-lg font-black text-gray-900 tracking-tight leading-none mb-2"
						>
							{{ member.name }}
						</h3>
						<p
							class="text-[10px] font-black text-primary uppercase tracking-[0.2em] mb-8"
						>
							{{ member.role }}
						</p>
				...
				>
					...
					<h3 class="text-sm font-black text-gray-900 tracking-widest uppercase mb-2">
						Expansion
					</h3>
					<p
						class="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed"
					>
						Onboard a new artisan
					</p>
				</div>
			</div>
		</div>

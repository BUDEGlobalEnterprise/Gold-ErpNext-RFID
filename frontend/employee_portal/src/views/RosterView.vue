			...
			<div class="grid grid-cols-4 gap-5">
				<div class="bg-white rounded-xl p-5 shadow-sm">
					...
					<p class="text-xs text-gray-500 mt-2 flex items-center gap-1">
						<span class="material-symbols-outlined text-sm text-[#064e3b]"
							>check_circle</span
						>
						On track this week
					</p>
				...
				<div class="bg-[#064e3b] rounded-xl p-5 shadow-sm relative overflow-hidden">
					...
					<span
						class="material-symbols-outlined absolute right-2 bottom-2 text-white/10 text-7xl"
						>star</span
					>
				</div>
			</div>
			...
			<div class="grid grid-cols-6 gap-4">
				...
				>
					...
					<div class="flex items-center justify-between mb-4">
						<div>
							<p class="text-[10px] font-medium text-gray-400 uppercase">
								{{ day.dayShort }}
							</p>
					...
					<div v-else class="flex-1 flex flex-col">
						<div
							class="flex-1 bg-gray-50 rounded-lg p-3 mb-3"
							:class="day.isToday ? 'bg-[#f0f7f4]' : ''"
						>
							...
							<p
								...
								class="text-xs text-[#064e3b] font-medium mt-2 flex items-center gap-1"
							>

	...
	<AppLayout>
		<div class="flex flex-col h-full">
			...
			<div class="flex gap-4 flex-1 overflow-hidden">
				<!-- Left: Repair Orders -->
				<div
					class="w-1/2 bg-white dark:bg-warm-dark-800 border border-gray-200 dark:border-warm-border rounded-xl overflow-auto"
				>
					<div
						v-for="ro in repairOrders"
						:key="ro.name"
				...
				<div class="w-1/2">
					...
					<div
						v-else
						class="h-full flex items-center justify-center bg-white dark:bg-warm-dark-800 border border-gray-200 dark:border-warm-border rounded-xl"
					>
	...
	try {
		const res = await frappe.call({
			...
			args: {
				doctype: 'Item',
				filters: {
					item_group: ['in', ['Findings', 'Melee Diamonds', 'Chain by Foot']],

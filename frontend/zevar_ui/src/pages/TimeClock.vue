	...
	<AppLayout>
		<div class="flex flex-col h-full">
			<div class="flex items-center justify-between gap-4 mb-4 flex-shrink-0">
				...
				>
					<svg
						...
						:class="{ 'animate-spin': hr.checkinStatusResource.loading }"
						fill="none"
						stroke="currentColor"
						viewBox="0 0 24 24"
					>
			...
			<div class="flex-1 overflow-y-auto">
				<div
					v-if="hr.checkinStatusResource.loading && !hr.todayStatus"
				...
				<div v-else class="max-w-md mx-auto space-y-4">
					...
					<div class="premium-card !p-6 text-center">
						...
						>
							<svg
								class="w-10 h-10"
								:class="isCheckedIn ? 'text-emerald-500' : 'text-gray-400'"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
							>
						...
						<div
							...
							:class="isCheckedIn ? 'text-emerald-600' : 'text-gray-500'"
						>
							{{ isCheckedIn ? 'Clocked In' : 'Clocked Out' }}
						</div>
						<div
							v-if="isCheckedIn && hr.todayStatus?.last_log_time"
						...
						<div
							...
							class="text-2xl font-bold text-[#D4AF37] mb-4"
						>
					...
					<div v-if="hr.todayStatus?.logs?.length" class="premium-card !p-4">
						...
						<div class="space-y-2">
							<div
								v-for="(log, i) in hr.todayStatus.logs"
								:key="i"
							...
							>
								<div class="flex items-center gap-2">
									<span
										...
										:class="
											log.log_type === 'IN' ? 'bg-emerald-500' : 'bg-red-500'
										"
									></span>
									<span

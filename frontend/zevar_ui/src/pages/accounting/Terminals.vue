	...
	<AppLayout>
		<div class="flex flex-col h-full">
			...
			<div class="flex-1 overflow-y-auto min-h-0">
				<div
					v-if="store.terminalsResource.loading && !store.terminals.length"
				...
				<div
					v-else-if="!store.terminals.length"

<template>
	<AppLayout>
		<div class="flex flex-col h-full">
			<div
				class="flex flex-col lg:flex-row lg:items-center justify-between gap-3 mb-4 flex-shrink-0"
			>
				...
				<div class="flex flex-col sm:flex-row gap-2 sm:items-center">
					...
					<div
						...
						class="relative group min-w-[200px] sm:min-w-[240px]"
					>
						<span
							class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 !text-lg text-gray-400 group-focus-within:text-[#D4AF37] transition-colors pointer-events-none"
							>search</span
						>
						<input
							v-model="search"
							...
							class="h-9 w-full rounded-lg border border-gray-200 dark:border-warm-border bg-white dark:bg-[#1C1F26] pl-10 pr-3 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent outline-none transition-all"
						/>
					</div>
					...
					>
						<span
							class="material-symbols-outlined !text-base group-hover:text-[#D4AF37]"
							:class="{ 'animate-spin': briefResource.loading }"
							>refresh</span
						>
					</button>
				</div>
			...
			<div
				class="flex gap-1 sm:gap-2 overflow-x-auto pb-3 border-b border-gray-200 dark:border-warm-border mb-4 flex-shrink-0"
			>
				<button
		...
		<SubscribeModal
			...
			:report-id="subscribeReportId"
			:report-title="subscribeReportTitle"

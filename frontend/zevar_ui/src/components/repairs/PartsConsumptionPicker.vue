<template>
	<div class="parts-picker">
		<div class="picker-header">
			...
			<span class="parts-count" v-if="consumedParts.length"
				>{{ consumedParts.length }} parts</span
			>
		</div>
		...
		<div v-if="suggestedParts.length" class="section">
			...
			>
				<span class="part-icon">{{
					part.component_type === 'Finding' ? '🔗' : '💎'
				}}</span>
				<span class="part-name">{{
					part.component_item_name || part.component_item
				}}</span>

	...
	<transition name="modal-fade">
		<div v-if="visible" class="modal-overlay" @click.self="$emit('cancel')">
			<div class="modal-card">
				...
				<p class="modal-desc">This item is currently being modified by another user.</p>
				...
				<div class="lock-details">
					...
					<div class="detail-row">
						...
						<span
							...
							:class="{ urgent: remainingSeconds <= 10 }"
						>
							{{ remainingFormatted }}
						</span>
					</div>
				...
				<p v-if="retryCount > 0" class="retry-info">Attempt {{ retryCount }}/3</p>
			</div>
		</div>
	</transition>
</template>

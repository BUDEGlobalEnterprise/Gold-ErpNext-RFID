<template>
	...
	>
		...
		<svg class="external-icon" width="10" height="10" viewBox="0 0 12 12">
			<path d="M3 1h8v8M11 1L1 11" stroke="currentColor" stroke-width="1.5" fill="none" />
		</svg>
	</a>

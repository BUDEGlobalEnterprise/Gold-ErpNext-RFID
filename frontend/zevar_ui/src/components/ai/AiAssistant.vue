    ...
    <div v-if="isOpen" class="ai-panel" :style="panelStyle">
      ...
      >
        ...
        <div class="ai-panel__actions">
          <button class="ai-btn-icon" @click="isHistoryOpen = !isHistoryOpen" :class="{ 'ai-btn-icon--active': isHistoryOpen }" title="History">
      ...
      <Transition name="ai-fade">
        <div v-if="isHistoryOpen" class="ai-history">
          ...
          <div class="ai-history__list">
            <div v-if="history.length === 0" class="ai-history__empty">No history yet</div>
            <button
            ...
            >
              ...
              <div class="ai-history__item-date">{{ new Date(chat.updatedAt).toLocaleDateString() }}</div>
            </button>
          </div>
        </div>
      </Transition>
      ...
      <div ref="messagesContainer" class="ai-panel__messages">
        ...
        <div v-if="!hasUserMessages" class="ai-welcome">
          ...
          <p class="ai-welcome__text">Hi! I'm Zev. I can help you find products, answer policy questions, and assist with automation.</p>
...
const quickActions = [
  { label: 'Find products', question: 'Show me trending gold necklaces', contextType: 'product' },
  { label: 'Store policies', question: 'What is the layaway cancellation policy?', contextType: 'policy' },
  { label: 'Repair help', question: 'What is the standard repair process?', contextType: 'repair' },
]
...
.ai-btn-icon:hover, .ai-btn-icon--active {
  color: white;

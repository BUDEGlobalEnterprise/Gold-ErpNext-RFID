					...
					<form @submit.prevent="submit" class="space-y-4">
						...
						<div>
							...
							<select
								...
								required
								class="w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-800 text-sm max-h-40"
							>
							...
							<div v-else class="space-y-2 max-h-40 overflow-y-auto">
								...
								>
									<div class="grid grid-cols-3 gap-2">
										<select
											v-model="stone.type"
											class="px-2 py-1 border rounded bg-white dark:bg-gray-900"
										>
						...
						>
							...
							<div class="grid grid-cols-2 gap-2">
								<select
									...
									class="px-2 py-1 border rounded text-sm bg-white dark:bg-gray-800"
								>
							...
							<input
								...
								class="mt-2 px-2 py-1 border rounded text-sm w-full bg-white dark:bg-gray-800"
							/>
						</div>
						...
						>
							...
							<div v-if="form.is_warranty_repair" class="mt-2">
								<input
									...
									class="w-full px-2 py-1 border rounded text-sm bg-white dark:bg-gray-800"
								/>
								<select
									v-model="form.warranty_claim_type"
									class="mt-2 w-full px-2 py-1 border rounded text-sm bg-white dark:bg-gray-800"
								>
